...
java %ADS_CONTROLS% %ADS_EXTENDED_OPERATIONS% -Dlog4j2.configurationFile="file:///%cd%/target/instance/conf/log4j.properties" -jar target/apacheds-service-2.0.0-M21.jar %cd%/target/instance
